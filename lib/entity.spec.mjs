...
test('entity:update', t => {
  ...
  t.is(entity.shouldDelete, false)
  t.is(entity.shouldCommit, true)
  t.throws(() => Entity.read('NULLISH').update(null))
  t.throws(() => Entity.read('NULLISH').update(undefined))
})
...
test('entity:set', t => {
  ...
  t.is(entity.shouldDelete, false)
  t.is(entity.shouldCommit, false)
  t.throws(() => Entity.read('NULLISH').set(null))
  t.throws(() => Entity.read('NULLISH').set(undefined))
})
